...
class shipmentStatusForm(forms.ModelForm):
    ...
    expectedDeliveryDate = forms.CharField(label='expectedDeliveryDate', max_length=100, widget= forms.DateInput(attrs={'class': 'form-control'}))
    pickUpDate = forms.CharField(label='pickUpDate', max_length=100, widget= forms.DateInput(attrs={'class': 'form-control'}))
    typeOfShipment = forms.CharField(label='typeOfShipment', max_length=100, widget= forms.DateInput(attrs={'class': 'form-control'}))



    class Meta:
        model = shipmentStatus
        fields = ['shippersFullname', 'shippersAddress', 'shippersPhone', 'shippersEmail', 'recieversFullname', 'recieversAddress', 'recieversPhone', 'recieversEmail', 'origin', 'batch', 'status', 'destination', 'carrier', 'typeOfShipment', 'weight', 'carrierReferenceNo', 'product', 'quantity', 'paymentMethod', 'expectedDeliveryDate', 'pickUpDate']
